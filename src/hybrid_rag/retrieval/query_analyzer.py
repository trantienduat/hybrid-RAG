...
_STOP_WORDS = frozenset(
    {
        ...
        "should", "may", "might", "shall", "can", "used",
        "to", "in", "on", "at", "by", "for", "from", "of", "or", "and",
        "but", "if", "as", "with",
        "this", "that", "what", "which", "how", "why", "when", "where",
        "who", "it", "its", "my", "your", "our", "their",
        "all", "any", "each", "every", "some", "no", "not",
        "show", "list", "get", "find", "tell", "give", "print",
        "code", "file", "class", "function", "method", "module",
        "between", "about", "also", "more", "than", "just", "only",
    }
)

...
\begin{titlepage}
    ...
    \begin{center}\sffamily
        {\fontsize{12}{14.4}\selectfont MINISTRY OF EDUCATION AND TRAINING\par}
        \vspace{4pt}
        {\fontsize{12}{14.4}\selectfont FPT UNIVERSITY\par}
        \vfill
        {\fontsize{15}{18}\selectfont MASTER'S THESIS\par}
        \vfill
        \begin{singlespace}
        ...
        \vfill
        {\fontsize{12}{14.4}\selectfont HO CHI MINH CITY, 2026\par}
    \end{center}
\end{titlepage}
...
\thispagestyle{empty}
\begin{center}
    {\sffamily\fontsize{15}{18}\selectfont \thesistitletext\par}
\end{center}
\vspace{18pt}
